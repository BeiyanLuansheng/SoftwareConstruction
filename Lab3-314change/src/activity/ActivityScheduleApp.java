...
public class ActivityScheduleApp {
	...
	public ActivityScheduleApp() {
		...
		JButton blockActivity = new JButton("Block ActivityEntry");
		buttonPanel.add(blockActivity);
		blockActivity.addActionListener(event -> blockActivity());
	...
	public void blockActivity() {
		...
		else if (((ActivityEntry<Material>) ae).block())
			JOptionPane.showMessageDialog(null, "阻塞成功！");
		else
			JOptionPane.showMessageDialog(null, "当前状态不可被阻塞！");
	}
