...
public class TrainEntryTest extends PlanningEntryInstanceTest<Carriage> {
	...
	public void testCancel() {
		PlanningEntry<Carriage> pe1 = entryInstance();
		assertTrue(pe1.cancel()); //此时为WATIING
		
		PlanningEntry<Carriage> pe2 = entryInstance();
		pe2.allocate();
		assertFalse(pe2.cancel()); //此时为ALLOCATED
		
		PlanningEntry<Carriage> pe3 = entryInstance();
		pe3.allocate();
		pe3.running();
