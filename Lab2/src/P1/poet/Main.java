...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        final GraphPoet nimoy = new GraphPoet(new File("src/P1/poet/graphPoetrySlam.txt"));
        final String input = "If wind flagged then remove and poverty,\n" + 
        					"and will its in drawing last over eyes.";
